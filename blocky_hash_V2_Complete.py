...
parser.add_argument("-output",help="Ouput directory for calculated MD5s. Recommended: 512, 1024, or 2048.", required=True)
...
if (args.k and args.s):
	...
	readandhashrec()
elif (args.u and args.s):
	campaign = "Undefined"
	readandhash()
	print ("Output file written to: %s" % outfile)
elif (args.u and args.d):
	campaign = "Undefined"
	print("A directory of Undefined files will be block hashed")
	readandhashdir()
elif (args.u and args.r):
	campaign = "Undefined"
	print("A group of directories containing key files will be block hashed")
	readandhashrec()
